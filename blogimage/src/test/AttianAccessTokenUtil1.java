...
/*
@Component
public class AttianAccessTokenUtil1 {
    private final Logger logger = LogManager.getLogger(AttianAccessTokenUtil1.class.getName());
    @Autowired
   ...
   public JSONArray getAccessToken(){
